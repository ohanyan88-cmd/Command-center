...
Հմտությունների համակարգը `.claude/skills/`-ում է՝ 63 հմտություն, ամեն մեկը՝ **առանձին, ապացույցով** վկայագրված (`certifications/<skill>.json`, L0–L4)։ Այս բաժինը վարքի ուղեցույց է. **հարկադրանքն ինքը մեխանիկական է** (`.claude/hooks/gate.py`) և քո հիշողությունից կախված չէ՝
