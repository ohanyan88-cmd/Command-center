...
SUITES = ["test_skills", "test_store", "test_failclosed", "test_hardening", "test_enforcement", "test_workspace", "test_runtime", "test_business", "test_boundary"]
...
def main():
    ...
    for kind in ("scenarios", "routing", "bypass", "boundary", "business"):
