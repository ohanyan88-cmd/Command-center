...
S("action_runtime","Controlled Hands — Action Runtime",A,
  ...
  triggers=("create a task","create task","task for","create the same task","move tomorrow","move the meeting","move today","reschedule","cancel tomorrow","cancel the meeting","cancel today","email the","email arman","email him","email her","email them",
            ...
            "just try again","timed out","try again","mark it complete","mark it done","without asking me","stop asking","looks good","remind me if","remind me when","add to calendar","create a meeting","book a meeting","schedule a meeting","նամակ ուղարկ","ուղարկիր նամակ","ուղարկիր","հանդիպում նշանակ","թասկ ստեղծ","սակագինը փոխ"),
  opt_in=("action","approval_text","event","to","cc","subject","body","draft","task_id","evidence","due","session_id"), tools_req=("python","filesystem","state_store","audit_log"), max_action="EXECUTE_MATERIAL",
...
skills += [
 ...
 S("management_communication","Outgoing Communication (Գև's voice)",G,"Draft outgoing messages (management, Finance, the company principal, follow-ups) in «Գև» voice, internal wording stripped; sending needs Head OK.",
   ...
   triggers=("write to","գրիր","message to","send finance","a follow-up to","follow-up message","outgoing","draft a message","reply to","email to","նամակ գրիր","draft an email","draft a reply"),
