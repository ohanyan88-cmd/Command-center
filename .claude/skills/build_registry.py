...
TOOL_INTENTS = {
    "email":       ("send email", "send an email", "email them", "email him", "email her", "նամակ ուղարկ", "մեյլ"),
    "calendar":    ("add to calendar", "create event", "calendar event", "book a meeting", "օրացույց"),
    "bitrix24":    ("create task in bitrix", "bitrix task create", "in bitrix", "բիտրիքսում", "crm update", "update the crm"),
