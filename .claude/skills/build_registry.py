...
S("action_runtime","Controlled Hands — Action Runtime",A,
  ...
  triggers=("create a task","create task","task for","create the same task","move tomorrow","move the meeting","move today","reschedule","cancel tomorrow","cancel the meeting","cancel today","email the","email arman","email him","email her","email them",
            ...
            "just try again","timed out","try again","mark it complete","mark it done","without asking me","stop asking","looks good","remind me if","remind me when","add to calendar","create a meeting","book a meeting","schedule a meeting","նամակ ուղարկ","ուղարկիր նամակ","հանդիպում նշանակ","թասկ ստեղծ","սակագինը փոխ"),
